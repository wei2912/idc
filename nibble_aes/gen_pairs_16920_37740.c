/* Generates PT-CT pairs of distinguishers with (16920, 37740):
 * START: 0100 0010 0001 1000
 * END: 1001 0011 0110 1100
 */
...
#define END_INACTIVE_MASK 0x0FF0FF00F00F00FF
